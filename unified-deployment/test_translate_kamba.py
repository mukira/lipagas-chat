...
Translate the following English text to Kamba.
Return ONLY the translated text, nothing else. Do NOT include quotes, explanations, or any other text.
Text: Mambo vipi, Mukira? 👋 You know me, I came from nothing, a chicken seller from Sugoi. I understand what it means to hustle every day for your family.
"""
