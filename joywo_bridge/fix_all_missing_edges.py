...
if modified:
    ...
    """
    with open("/root/lipagas_bridge/fix_all_missing_edges.sql", "w") as f:
        f.write(sql)
    
    subprocess.check_call("docker exec -i typebot-typebot-db-1 psql -U postgres -d typebot < /root/lipagas_bridge/fix_all_missing_edges.sql", shell=True)
