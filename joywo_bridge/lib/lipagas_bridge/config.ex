defmodule LipagasBridge.Config do
  @moduledoc """
  ...
  def verify_token,  do: System.get_env("META_VERIFY_TOKEN") || "lipagas_secure_meta_token"
  ...
  def chatwoot_bot_token,  do: System.get_env("CHATWOOT_BOT_TOKEN")  || "bq9HFKPLGvsdCySk8jTt99gt"
  ...
  # ─── Server ───────────────────────────────────────────────────────────
  def port, do: String.to_integer(System.get_env("PORT") || "4001")

  # ─── JoyWO Bots ───────────────────────────────────────────────────────
  def joywo_typebot_slug,  do: "my-typebot-jpjwqnz"
  def presidential_bot_id, do: "presidential-bot-0u2tznio"

  # ─── Catalog Sets ─────────────────────────────────────────────────────
  def lipagas_catalog_sets do
    %{
