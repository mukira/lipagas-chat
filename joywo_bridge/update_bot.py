...
with open("/root/lipagas_bridge/update.sql", "w") as f:
    f.write(sql_content)

print("SQL file generated successfully.")

# Run the SQL file in docker
subprocess.check_call("docker exec -i typebot-typebot-db-1 psql -U postgres -d typebot < /root/lipagas_bridge/update.sql", shell=True)
