...
- **Zero Dead-End Interactive Follow-Up**: Immediately following the AI response, the bridge MUST send an interactive button card asking the user what they wish to explore next, presenting options: `❓ Ask AI` and `⬅️ Back to Main Menu`. This ensures the chat never freezes or lands in a dead end.
