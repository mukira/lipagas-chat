...
"""
    with open("/root/presidential_bridge/fix_tokens_text.sql", "w") as f:
        f.write(sql_content)

    subprocess.check_call("docker exec -i typebot-typebot-db-1 psql -U postgres -d typebot < /root/presidential_bridge/fix_tokens_text.sql", shell=True)
