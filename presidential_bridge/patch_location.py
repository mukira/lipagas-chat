...
with open('/root/presidential_bridge/lib/presidential_bridge/meta_handler.ex', 'r') as f:
    content = f.read()
...
with open('/root/presidential_bridge/lib/presidential_bridge/meta_handler.ex', 'w') as f:
    f.write(content)
