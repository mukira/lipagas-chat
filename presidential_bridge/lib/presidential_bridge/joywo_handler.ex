defmodule PresidentialBridge.JoywoHandler do
  @moduledoc """
  ...
  """
  alias PresidentialBridge.{Config, Meta, Session, Typebot, Mpesa}
  ...
  defp build_joywo_payload(phone, combined_text, image_url, input) do
    cond do
      ...
      String.contains?(combined_text, "SHOW_FLOW:") ->
        case PresidentialBridge.Interceptor.build_flow_payload(combined_text, phone) do
          {:ok, payload} -> payload
          _ -> nil
        end
